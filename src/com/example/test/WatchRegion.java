...
//	private List<Map<String, String>> watchRegionList; // 定义显示的内容包装
...
//		watchRegionListView.setAdapter(simpleAdapter);
		...
		watchRegionListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Loger.i("position:" + position + "list内容:" + watchregionStringList.get(position));
		...
		AVCloud.callFunctionInBackground("userSubscribe", params,
				new FunctionCallback<Object>() {
					public void done(Object object, AVException e) {
						if (e == null) {
							Loger.i("删除关注区域成功: " + object);
							Toast.makeText(WatchRegion.this, "删除成功",
							...
							Loger.d("sms result: " + e.getCode() + ", "
									+ e.getMessage());
							Toast.makeText(WatchRegion.this, "删除失败",
									Toast.LENGTH_SHORT).show();
						}
					};
				});
